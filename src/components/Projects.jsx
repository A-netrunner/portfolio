...
const projects = [
  ...
  },
  {
    ...
    image: images["Booking vehicle"],
    demo: "#",
    github: "https://github.com/A-netrunner/Booking-vehicle-in-php",
  },
  {
    title: "Bookvers",
    description: "A book review and recommendation platform",
    tech: ["Expo", "JavaScript", "MongoDB"],
    image: images["Bookvers"],
    demo: "https://bookverse-6g3e5v8b6-a-netrunners-projects.vercel.app/",
    github: "https://github.com/A-netrunner/bookstuffs",
  },
  {
    title: "Portfolio Website",
    description: "Personal portfolio website with modern design",
    tech: ["React", "Tailwind CSS", "Framer Motion", " Mail JS"],
    image: images["Portfolio Website"],
    demo: "https://a-netrunner.github.io/portfolio/",
    github: "https://github.com/A-netrunner/portfolio",
  },
];
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto ">
          {projects.map((project, index) => (
            <div
              key={index}
              className={`project-card backdrop-blur-sm bg-white/5 rounded-xl overflow-hidden transform transition-all duration-500 border border-gray-700 ${
